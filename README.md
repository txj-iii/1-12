...
| `/api/chat` | POST | 多轮对话 |
| `/api/generate_replies` | POST | 生成 3 个回复候选 |
...
|-------------|-----------|----------|
| 窗口参数 (window_size/increment) | WINDOW_SIZE=20, WINDOW_INCREMENT=10 | [config.py:18](pyserial_measure_app/word_recognition/config.py#L18) |
